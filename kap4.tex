...
\begin{center}
\includegraphics[scale=0.3]{gleichverteilung.png}
\end{center}
...
\item \textbf{Verteilungsfunktion:} $F_X(t) = \int\limits_{-\infty}^t f_X(s) \: ds = \begin{cases} 1 - e^{-\lambda t} \mbox{für } t \geq 0 \\ 0 & \mbox{für } t < 0 \end{cases}$
...
\end{itemize}
\begin{center}
\includegraphics[scale=0.55]{normalverteilung.png}
\end{center}
